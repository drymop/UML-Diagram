...
public class JavaProject implements Project {
	...
	private Class.Builder classBuilder = new Class.Builder();
	private Interface.Builder interfaceBuilder = new Interface.Builder();
	private Method.Builder methodBuilder = new Method.Builder();
	private Property.Builder propertyBuilder = new Property.Builder();
	...
	public void removeAll() {
		classBuilder = new Class.Builder();
